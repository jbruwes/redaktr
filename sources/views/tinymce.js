      ...
      config: {
        ...
        templates: [
          ...
          },
          {
            ...
            content: '<div class="ui basic fitted segment mceNonEditable" data-id="header" data-auto="" data-path="" data-date="false"><div class="content"><div class="ui massive dividing header fluid container hvr-icon-wobble-vertical"><i class="hvr-icon icon " style="vertical-align:top;padding-top:0.3em"><!-- --></i><span class="content"><span class="sub header"><!-- --></span></span></div></div></div>'
          }
        ],
