      ...
      config: {
        ...
        templates: [
          ...
          },
          {
            ...
            content: '<div class="mceNonEditable" data-carousel=""><div><div class="ui dimmable dimmed fitted blurring segment"><div class="ui active very light dimmer"><div class="content"><h2 class="ui inverted header">First slide</h2></div></div><div class="ui fluid placeholder"><div class="image">&nbsp;</div></div></div></div><div hidden=""><div class="ui dimmable dimmed fitted blurring segment"><div class="ui active very light dimmer"><div class="content"><h2 class="ui inverted header">Second slide</h2></div></div><div class="ui fluid placeholder"><div class="image">&nbsp;</div></div></div></div><div hidden=""><div class="ui dimmable dimmed fitted blurring segment"><div class="ui active very light dimmer"><div class="content"><h2 class="ui inverted header">Third slide</h2></div></div><div class="ui fluid placeholder"><div class="image">&nbsp;</div></div></div></div></div>'
          }
        ],
