      ...
      config: {
        ...
        templates: [
          ...
          },
          {
            ...
            content: '<div class="mceNonEditable" data-carousel="" data-pager="false"><div><div class="ui dimmable dimmed fitted basic segment"><div class="ui active very light dimmer"><div class="content"><h2 class="ui inverted header">First slide</h2></div></div><div class="ui fluid placeholder"><div class="image" style="height:100vh;background-image:url();background-size:cover;">&nbsp;</div></div></div></div><div hidden=""><div class="ui dimmable dimmed fitted basic segment"><div class="ui active very light dimmer"><div class="content"><h2 class="ui inverted header">Second slide</h2></div></div><div class="ui fluid placeholder"><div class="image" style="height:100vh;background-image:url();background-size:cover;">&nbsp;</div></div></div></div><div hidden=""><div class="ui dimmable dimmed fitted basic segment"><div class="ui active very light dimmer"><div class="content"><h2 class="ui inverted header">Third slide</h2></div></div><div class="ui fluid placeholder"><div class="image" style="height:100vh;background-image:url();background-size:cover;">&nbsp;</div></div></div></div></div>'
          },
          {
            title: 'particles',
            description: 'A particles template',
            content: '<div id="' + webix.uid() + '" class="ui grey inverted basic segment mceNonEditable" style="height: 100vh;" data-particles="default"><div class="ui active very light center dimmer"><div class="content"><h2>Header</h2>particles example</div></div></div>'
          }
        ],
