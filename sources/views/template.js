...
export default class TemplateView extends JetView {
	...
	_genHtml(identity) {
		this._html =
			...
			'<script>' +
			"document.write('<link rel=\"stylesheet\" href=\"/" + AWS.config.credentials.identityId + ".cdn.css'+(window.location.hostname===\"www.redaktr.com\"||window.location.hostname===\"dev.redaktr.com\"?\"?\"+window.btoa(Math.random()):window.location.search.charAt(0)+window.btoa(unescape(encodeURIComponent(window.location.search))))+'\">');" +
			'</script>' +
			(window.location.hostname === 'dev.redaktr.com' ?
			...
			'<script>' +
			"document.write('<link rel=\"stylesheet\" href=\"/" + AWS.config.credentials.identityId + ".css'+(window.location.hostname===\"www.redaktr.com\"||window.location.hostname===\"dev.redaktr.com\"?\"?\"+window.btoa(Math.random()):window.location.search.charAt(0)+window.btoa(unescape(encodeURIComponent(window.location.search))))+'\">');" +
			'</script>' +
